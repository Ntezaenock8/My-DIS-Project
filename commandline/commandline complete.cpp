...
if(rows==1){
    ...
    scanf("%d",&assignNo);
    char query2[]={"select Q1 from assignment where AssignmentID = %d"};
    char buff2[255];
    sprintf(buff2,query2,assignNo);
    //run query
    ...
    //insert marks into database
     ...
     sprintf(buff11,query11,get_testmarks[9],assignNo,usercode,get_testmarks[8],get_testmarks[0],get_testmarks[1],get_testmarks[2],get_testmarks[3],get_testmarks[4],get_testmarks[5],get_testmarks[6],get_testmarks[7],get_testmarks[8]);
